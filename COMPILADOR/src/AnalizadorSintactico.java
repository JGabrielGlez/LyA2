...
private void validarNoDuplicada(String nombreVariable, int linea) throws ParseException {
    ...
    private DeclaracionSensorNodo parsearDeclaracionSensor(Analizador.Token identificador) throws ParseException {
       ...
       validarNoDuplicada(identificador.lexema, identificador.linea);
        ...
        Analizador.Token numero = consumirTipo("NUMERO");   
        
        //siempre debe ser numero entero , ya que hace referencia a los pines
        validarNumeroEntero(numero.lexema, numero.linea);
        /////////////////////////7
        
        
        int puerto = (int) Double.parseDouble(numero.lexema);
        if(puerto>255) throw new ParseException("Valor asignado supera los límites físicos (0-255), en línea: "+numero.linea);
